...
// issue warp
libcudart.so!shader_core_ctx::issue_warp(shader_core_ctx * const this, register_set & pipe_reg_set, const warp_inst_t * next_inst, const active_mask_t & active_mask, unsigned int warp_id, unsigned int sch_id) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/src/gpgpu-sim/shader.cc:1209)
trace_shader_core_ctx::issue_warp(trace_shader_core_ctx * const this, register_set & warp, const warp_inst_t * pI, const active_mask_t & active_mask, unsigned int warp_id, unsigned int sch_id) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/trace-driven/trace_driven.cc:738)
libcudart.so!scheduler_unit::cycle(scheduler_unit * const this) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/src/gpgpu-sim/shader.cc:1741)
libcudart.so!shader_core_ctx::issue(shader_core_ctx * const this) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/src/gpgpu-sim/shader.cc:1417)
libcudart.so!shader_core_ctx::cycle(shader_core_ctx * const this) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/src/gpgpu-sim/shader.cc:4478)
libcudart.so!simt_core_cluster::core_cycle(simt_core_cluster * const this) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/src/gpgpu-sim/shader.cc:5384)
libcudart.so!gpgpu_sim::cycle(gpgpu_sim * const this) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/src/gpgpu-sim/gpu-sim.cc:2764)
accel_sim_framework::simulate(accel_sim_framework * const this) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/accel-sim.cc:165)
accel_sim_framework::simulation_loop(accel_sim_framework * const this) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/accel-sim.cc:75)
main(int argc, const char ** argv) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/main.cc:30)

libcudart.so!shader_core_ctx::create_schedulers(shader_core_ctx * const this) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/src/gpgpu-sim/shader.cc:243)
trace_shader_core_ctx::trace_shader_core_ctx(trace_shader_core_ctx * const this, gpgpu_sim * gpu, simt_core_cluster * cluster, unsigned int shader_id, unsigned int tpc_id, const shader_core_config * config, const memory_config * mem_config, shader_core_stats * stats) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/trace-driven/trace_driven.h:205)
trace_simt_core_cluster::create_shader_core_ctx(trace_simt_core_cluster * const this) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/trace-driven/trace_driven.cc:585)
trace_simt_core_cluster::trace_simt_core_cluster(trace_simt_core_cluster * const this, gpgpu_sim * gpu, unsigned int cluster_id, const shader_core_config * config, const memory_config * mem_config, shader_core_stats * stats, memory_stats_t * mstats) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/trace-driven/trace_driven.h:188)
trace_gpgpu_sim::createSIMTCluster(trace_gpgpu_sim * const this) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/trace-driven/trace_driven.cc:569)
trace_gpgpu_sim::trace_gpgpu_sim(trace_gpgpu_sim * const this, const gpgpu_sim_config & config, gpgpu_context * ctx) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/trace-driven/trace_driven.h:174)
accel_sim_framework::gpgpu_trace_sim_init_perf_model(accel_sim_framework * const this, int argc, const char ** argv, gpgpu_context * m_gpgpu_context, trace_config * m_config) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/accel-sim.cc:238)
accel_sim_framework::accel_sim_framework(accel_sim_framework * const this, int argc, const char ** argv) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/accel-sim.cc:29)
main(int argc, const char ** argv) (/home/hjs/dev/accel-sim/accel-sim-framework/gpu-simulator/main.cc:29)

libcudart.so!ldst_unit::process_memory_access_queue_l1cache(ldst_unit * const this, l1_cache * cache, warp_inst_t & inst) (\home\hjs\dev\accel-sim\accel-sim-framework\gpu-simulator\gpgpu-sim\src\gpgpu-sim\shader.cc:2668)
libcudart.so!ldst_unit::memory_cycle(ldst_unit * const this, warp_inst_t & inst, mem_stage_stall_type & stall_reason, mem_stage_access_type & access_type) (\home\hjs\dev\accel-sim\accel-sim-framework\gpu-simulator\gpgpu-sim\src\gpgpu-sim\shader.cc:3029)
libcudart.so!ldst_unit::cycle(ldst_unit * const this) (\home\hjs\dev\accel-sim\accel-sim-framework\gpu-simulator\gpgpu-sim\src\gpgpu-sim\shader.cc:3705)
...
libcudart.so!shader_core_ctx::cycle(shader_core_ctx * const this) (\home\hjs\dev\accel-sim\accel-sim-framework\gpu-simulator\gpgpu-sim\src\gpgpu-sim\shader.cc:4532)
libcudart.so!simt_core_cluster::core_cycle(simt_core_cluster * const this) (\home\hjs\dev\accel-sim\accel-sim-framework\gpu-simulator\gpgpu-sim\src\gpgpu-sim\shader.cc:5440)
libcudart.so!gpgpu_sim::cycle(gpgpu_sim * const this) (\home\hjs\dev\accel-sim\accel-sim-framework\gpu-simulator\gpgpu-sim\src\gpgpu-sim\gpu-sim.cc:2768)
accel_sim_framework::simulate(accel_sim_framework * const this) (\home\hjs\dev\accel-sim\accel-sim-framework\gpu-simulator\accel-sim.cc:165)
accel_sim_framework::simulation_loop(accel_sim_framework * const this) (\home\hjs\dev\accel-sim\accel-sim-framework\gpu-simulator\accel-sim.cc:75)
main(int argc, const char ** argv) (\home\hjs\dev\accel-sim\accel-sim-framework\gpu-simulator\main.cc:30)
